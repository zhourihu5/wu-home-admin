  ...
  <div class="service-index">
    ...
    <div class="service-index-table">
      ...
      >
        ...
        <el-table-column align="center" :label="$t('table.serviceProvider')" width="350">
          <template
            slot-scope="scope"
          >{{ scope.row.providerName ? scope.row.providerName : $t('table.noTime') }}</template>
        </el-table-column>
        <el-table-column align="center" :label="$t('table.product')" width="310">
          <template
            slot-scope="scope"
          >{{ scope.row.flag != null && scope.row.flag != "" ? getFlagText(scope.row.flag) : $t('table.noTime') }}</template>
        </el-table-column>
        <el-table-column align="center" :label="$t('table.createTime')" width="310">
          <template
            slot-scope="scope"
          >{{ scope.row.createDate ? scope.row.createDate : $t('table.noTime') }}</template>
        </el-table-column>
        <el-table-column :label="$t('table.operation')" align="center" width="305">
