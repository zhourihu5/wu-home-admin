  ...
  <div class="user">
    <div class="app-container">
      ...
      >
        ...
        <el-table-column :label="$t('table.roleName')" align="center" width="310">
          <template slot-scope="scope">{{ scope.row.roleName }}</template>
        </el-table-column>
        <el-table-column :label="$t('table.addUser')" width="310" align="center">
          <template slot-scope="scope">{{ scope.row.addUser }}</template>
        </el-table-column>
        <el-table-column
          align="center"
          prop="created_at"
      ...
      <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
        ...
        >
          ...
          <el-form-item :label="$t('table.nickName')" prop="userName">
            <el-input v-model="temp.userName"/>
          </el-form-item>
